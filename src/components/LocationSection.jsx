...
function HoursRow({ day, h, isToday }) {
  return (
    <div style={{ display:'flex',alignItems:'baseline',padding:'13px 0',borderBottom:'1px solid var(--border)',position:'relative' }}>
    ...
    <section id="location-section" style={{ background:'var(--warm)', padding:'80px 0' }}>
      ...
      <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',maxWidth:1100,margin:'0 auto',padding:'0 64px',gap:56 }} className="loc-grid">
        ...
        <div ref={infoRef} className="reveal-left">
          ...
          {/* Hours — dotted leader style matching menu */}
          {locHours.length>0&&(
            <div style={{ paddingLeft:16 }}>
              ...
              {DAYS.map((day,di)=>{
                ...
                return <HoursRow key={di} day={day} h={h} isToday={di===today}/>
              })}
